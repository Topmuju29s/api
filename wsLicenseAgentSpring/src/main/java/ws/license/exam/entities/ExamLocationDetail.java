...
@Entity(name = "exam_location_detail")
@Table(name = "exam_location")
public class ExamLocationDetail 
{	
	...
	public ExamLocationDetail() {}

	public ExamLocationDetail(int locationId, String orgCode, String provinceCode, String locationDetail, String locationType,
